    ...
    return (
        ...
        >
            <Link href={href} className="block w-full h-full outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-[2rem]">
                <div
                    className="flex flex-col p-5 h-full gap-3 rounded-[2rem] shadow-lg border border-white/40 dark:border-white/10 relative overflow-hidden liquid-glass transition-all duration-300"
                >
